...
public class DashboardAppliances  extends Activity {

    String url_flip="http://fkrt.it/w!P9I!NNNN";
    String url_amazon="http://bit.ly/2tlBBIS";
    String url_shopclues="http://clnk.in/e2b1";
    String url_jabong="https://bit.ly/2tlygcN";
    String url_infibeam=" https://bit.ly/2tvU4Xc";
    String url_aliexpress="https://bit.ly/2uGDwKU";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flipkart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent web=new Intent(DashboardAppliances.this,MainActivity.class);
