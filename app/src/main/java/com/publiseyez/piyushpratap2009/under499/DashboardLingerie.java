...
public class DashboardLingerie  extends Activity {

    String url_flip="http://fkrt.it/BTytvTuuuN";
    String url_amazon="http://bit.ly/2tvU5Ky";
    String url_shopclues="http://clnk.in/e2b6";
    String url_jabong="https://bit.ly/2tllo6h";
    String url_infibeam="https://bit.ly/2tvJ6AN";
    String url_aliexpress="https://bit.ly/2uHylKV";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flipkart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent web=new Intent(DashboardLingerie.this,MainActivity.class);
