...
public class DashboardShoes  extends Activity {

    String url_flip="http://fkrt.it/w!7UF!NNNN";
    String url_amazon="http://bit.ly/2tvN6Bm";
    String url_shopclues="http://clnk.in/e2b8";
    String url_jabong="https://bit.ly/2tm05By";
    String url_infibeam="https://bit.ly/2tvUmxg";
    String url_aliexpress="https://bit.ly/2tLOPyy";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flipkart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent web=new Intent(DashboardShoes.this,MainActivity.class);
