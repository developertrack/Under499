...
public class DashboardSunglasses  extends Activity {

    String url_flip="http://fkrt.it/wTaZI!NNNN";
    String url_amazon="http://bit.ly/2tw45n7";
    String url_shopclues="http://clnk.in/e2b4";
    String url_jabong="https://bit.ly/2tlwhoR";
    String url_infibeam="https://bit.ly/2tlwicf";
    String url_aliexpress="https://bit.ly/2uHs163";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flipkart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent web=new Intent(DashboardSunglasses.this,MainActivity.class);
