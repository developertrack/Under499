...
public class DashboardWatch  extends Activity {

    String url_flip="http://fkrt.it/BT7esTuuuN";
    String url_amazon="http://bit.ly/2tlHiWY";
    String url_shopclues="http://clnk.in/e2b3";
    String url_jabong="https://bit.ly/2tw6vSL";
    String url_infibeam="https://bit.ly/2tvLOGA";
    String url_aliexpress=" https://bit.ly/2uH8K4R";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flipkart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent web=new Intent(DashboardWatch.this,MainActivity.class);
